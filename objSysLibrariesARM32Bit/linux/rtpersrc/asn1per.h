 ...
 * tracing.  It is now deprecated and has been replaced by
 * function pu_initRtxDiagBitFieldList which works with the common
 * context bit tracing list structure rather than the ASN.1 PER-specific
 * list.
 *
 * @param pctxt       A pointer to a context structure.
